      ...
      <div>
        ...
        <div className="getting-started--steps space-top-2">
          ...
          <div className="typography-4">
            ...
            product into InfiniteReserve.
          </div>
          <div className="typography-7">Set InfiniteReserve URL in your product</div>
          <div className="typography-4">
            To provide seemless experience to your users, add a link from your
            product to InfiniteReserve. By triggering a button for example from your
            product, your users will be securely transferred to InfiniteReserve with
            their details.
          </div>
          <div className="typography-7">
            Securely transmit user information to InfiniteReserve
          </div>
          <div className="typography-4">
